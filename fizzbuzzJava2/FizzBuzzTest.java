...
public class FizzBuzzTest {
  ...
  @Test
  public void returnsFizzAndFizzFor30to31() {
  ...
  @Test
  public void returnsMixFor70to71() {

    fb.addFilter(new Filter(7, "Mix", true));

    Object[] expected = {Buzz + Mix, Mix};
    Object[] actual = fb.filter(range(70, 71));
    assertArrayEquals(expected, actual);
  }
